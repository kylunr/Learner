...
class Calendar extends React.Component {
    ...
    handleDrop = (event) => {
        ...
        tempArray.push(
            {title: event.event.title, start: event.event.start, end: event.event.end, id: id}
        );
    ...
    handleChange = (event) => {
        ...
        let tempArray = this.state.calendarEvents.slice();
        tempArray[index] = {title: event.event.title, start: event.event.start, end: event.event.end, id: event.event.id};
